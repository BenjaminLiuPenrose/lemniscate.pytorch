...
trainloader = torch.utils.data.DataLoader(trainset, batch_size=8*16, shuffle=False, num_workers=2)
...
testloader = torch.utils.data.DataLoader(testset, batch_size=8*16, shuffle=False, num_workers=2)
