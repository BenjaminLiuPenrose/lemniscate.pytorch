...
trainloader = torch.utils.data.DataLoader(trainset, batch_size=int(128/ 2 / args.sample_duration), shuffle=False, num_workers=2)
...
testloader = torch.utils.data.DataLoader(testset, batch_size=int(128/ 2 / args.sample_duration), shuffle=False, num_workers=2)
