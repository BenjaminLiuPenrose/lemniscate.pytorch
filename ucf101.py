...
for epoch in range(start_epoch, start_epoch + 100):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(state, './checkpoint/ckpt_ucf101_test26.t7')
        best_acc = acc
        print("="*100+"saving best_acc_ucf_test26.npy"+"="*100)
        ### modify 0814
        ...
        np.save("best_acc_ucf_cls_test26.npy", X)
        np.save("best_acc_ucf_clsy_test26.npy", y)
        ### modify 0814
