...
train_batch_sampler = BalancedBatchSampler(trainset.indices, n_classes=10*25, n_samples=1)
...
test_batch_sampler = BalancedBatchSampler(testset.indices, n_classes=10*25, n_samples=1)
